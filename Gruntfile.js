    ...
    buildcontrol: {
      dist: {
        options: {
          ...
          remote: 'git@github.com:centresource/generator-playbook.git',
          branch: 'gh-pages'
        }
      }
    },
      ...
      dist: {
        options: {
          patterns: [
            {
              match: /("|'?)\/?assets\//g,
              replacement: '$1http://centresource.github.io/generator-playbook/assets/'
            },
            {
              match: /(<a[^>]*href="?)(\/)/g,
              replacement: '$1http://centresource.github.io/generator-playbook/'
            },
            {
              match: /(<form[^>]*action="?)(\/)/g,
              replacement: '$1http://centresource.github.io/generator-playbook/'
